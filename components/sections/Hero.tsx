...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid min-h-[calc(100vh-7rem)] w-full max-w-[1240px] items-center gap-12 px-5 pb-14 sm:px-6 lg:grid-cols-[1fr_0.95fr] lg:px-8">
        <div className="relative z-10 max-w-[42rem]">
          <div
            data-hero="eyebrow"
            className="inline-flex rounded-full border border-[color:var(--line)] bg-white/55 px-4 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-palm shadow-[0_12px_30px_var(--shadow)]"
          >
          ...
          <h1
            data-hero="title"
            className="mt-6 max-w-3xl text-balance font-serif text-5xl leading-[1.02] text-coconut sm:text-6xl lg:text-7xl"
          >
          ...
          <p
            data-hero="copy"
            className="mt-6 max-w-2xl text-pretty text-lg leading-8 text-text-soft sm:text-xl"
          >
          ...
          >
            <Button href={siteContent.hero.primaryCta.href} variant="primary">
          ...
          <ul
            data-hero="notes"
            className="mt-10 grid gap-3 text-sm leading-6 text-text-soft sm:grid-cols-3"
          >
            {siteContent.hero.trustNotes.map((note) => (
              <li
                key={note}
                className="rounded-[1.5rem] border border-[color:var(--line)] bg-white/42 p-4 shadow-[0_18px_48px_var(--shadow)]"
              >
                {note}
              </li>
            ))}
        ...
        <div ref={visualRef} className="relative z-10 mx-auto w-full max-w-[36rem]">
          <div
            className="relative aspect-[5/6] overflow-hidden rounded-[2rem] border border-[color:var(--line)] bg-[linear-gradient(180deg,rgba(247,250,242,0.92),rgba(219,231,216,0.92))] shadow-[0_30px_90px_var(--shadow)]"
            data-parallax
          >
            ...
            <div className="absolute inset-6 overflow-hidden rounded-[1.6rem] border border-white/60 shadow-[inset_0_1px_0_rgba(255,255,255,0.7)]">
              <Image
            ...
            <div
              className="absolute bottom-6 left-6 w-[44%] overflow-hidden rounded-[1.5rem] border border-white/70 bg-white/55 p-3 shadow-[0_20px_45px_var(--shadow)] backdrop-blur-sm"
              data-parallax
            >
              ...
              <p className="mt-3 text-sm leading-6 text-coconut">
            ...
            {!prefersReducedMotion ? (
              <div className="absolute inset-0 z-20">
                <HeroPrism className="h-full w-full opacity-95" />
              </div>
            ) : null}
          </div>
        </div>
