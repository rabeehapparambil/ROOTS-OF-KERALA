...
export default function Footer() {
  return (
    <footer className="border-t border-[color:var(--line)] bg-[rgba(244,249,240,0.64)]">
      <div className="mx-auto flex w-full max-w-[1240px] flex-col gap-4 px-5 py-8 text-sm text-text-soft sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:px-8">
